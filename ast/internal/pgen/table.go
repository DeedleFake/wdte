...
var Table = map[Lookup]Rule{
	...
	{Term: newTerm("(@"), NTerm: newNTerm("lambda")}:       newRule(newTerm("(@"), newNTerm("funcmods"), newTerm("id"), newNTerm("patdecls"), newTerm("=>"), newNTerm("cexprs"), newTerm(")")),
	{Term: newTerm("["), NTerm: newNTerm("letassign")}:     newRule(newNTerm("patdecl"), newTerm("=>"), newNTerm("expr")),
	{Term: newTerm("id"), NTerm: newNTerm("letassign")}:    newRule(newNTerm("funcmods"), newTerm("id"), newNTerm("patdecls"), newTerm("=>"), newNTerm("expr")),
	{Term: newTerm("memo"), NTerm: newNTerm("letassign")}:  newRule(newNTerm("funcmods"), newTerm("id"), newNTerm("patdecls"), newTerm("=>"), newNTerm("expr")),
	{Term: newTerm("let"), NTerm: newNTerm("letexpr")}:     newRule(newTerm("let"), newNTerm("letassign")),
	{Term: newTerm("["), NTerm: newNTerm("patdecl")}:       newRule(newTerm("["), newNTerm("argdecls"), newTerm(";"), newTerm("]")),
	{Term: newTerm("id"), NTerm: newNTerm("patdecl")}:      newRule(newTerm("id")),
	{Term: newTerm("["), NTerm: newNTerm("patdecls")}:      newRule(newNTerm("patdecl"), newNTerm("patdecls")),
	{Term: newTerm("id"), NTerm: newNTerm("patdecls")}:     newRule(newNTerm("patdecl"), newNTerm("patdecls")),
	{Term: newTerm("=>"), NTerm: newNTerm("patdecls")}:     newRule(newEpsilon()),
	...
	{Term: newTerm(":"), NTerm: newNTerm("slot")}:          newRule(newTerm(":"), newNTerm("patdecl")),
