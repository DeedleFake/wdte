...
var Table = map[Lookup]Rule{
	...
	{Term: newTerm("["), NTerm: newNTerm("letassign")}:     newRule(newTerm("["), newTerm("id"), newNTerm("argdecls"), newTerm(";"), newTerm("]"), newTerm("=>"), newNTerm("expr")),
	...
	{Term: newTerm(":"), NTerm: newNTerm("slot")}:          newRule(newTerm(":"), newNTerm("slotassign")),
	{Term: newTerm("--"), NTerm: newNTerm("slot")}:         newRule(newEpsilon()),
	{Term: newTerm("->"), NTerm: newNTerm("slot")}:         newRule(newEpsilon()),
	{Term: newTerm("-|"), NTerm: newNTerm("slot")}:         newRule(newEpsilon()),
	{Term: newTerm(";"), NTerm: newNTerm("slot")}:          newRule(newEpsilon()),
	{Term: newTerm("=>"), NTerm: newNTerm("slot")}:         newRule(newEpsilon()),
	{Term: newTerm("["), NTerm: newNTerm("slotassign")}:    newRule(newTerm("["), newTerm("id"), newNTerm("argdecls"), newTerm(";"), newTerm("]")),
	{Term: newTerm("id"), NTerm: newNTerm("slotassign")}:   newRule(newTerm("id")),
