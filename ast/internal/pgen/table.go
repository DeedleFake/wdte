...
var Table = map[Lookup]Rule{
	...
	{Term: newTerm("id"), NTerm: newNTerm("single")}:        newRule(newTerm("id"), newNTerm("sub")),
	...
	{Term: newTerm("switch"), NTerm: newNTerm("single")}:    newRule(newNTerm("switch"), newNTerm("sub")),
	{Term: newTerm("("), NTerm: newNTerm("single")}:         newRule(newNTerm("compound"), newNTerm("sub")),
	...
	{Term: newTerm(";"), NTerm: newNTerm("slot")}:           newRule(newEpsilon()),
	{Term: newTerm("{"), NTerm: newNTerm("slot")}:           newRule(newEpsilon()),
	{Term: newTerm("."), NTerm: newNTerm("sub")}:            newRule(newTerm("."), newTerm("id"), newNTerm("sub")),
