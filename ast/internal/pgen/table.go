...
var Table = map[Lookup]Rule{
	...
	{Term: newTerm("memo"), NTerm: newNTerm("assign")}:     newRule(newNTerm("funcmods"), newTerm("id"), newNTerm("argdecls"), newTerm("=>"), newNTerm("expr")),
	{Term: newTerm("id"), NTerm: newNTerm("assign")}:       newRule(newNTerm("funcmods"), newTerm("id"), newNTerm("argdecls"), newTerm("=>"), newNTerm("expr")),
	{Term: newTerm("["), NTerm: newNTerm("assign")}:        newRule(newTerm("["), newTerm("id"), newNTerm("argdecls"), newTerm(";"), newTerm("]"), newTerm("=>"), newNTerm("expr")),
	...
	{Term: newTerm("let"), NTerm: newNTerm("letexpr")}:     newRule(newTerm("let"), newNTerm("assign")),
